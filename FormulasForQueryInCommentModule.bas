...
Public Function componentPlantManualFill(Optional how_many_days_from_today As String, Optional rqm_table As Range, Optional transit_table As Variant) As String
...
Attribute componentPlantManualFill.VB_ProcData.VB_Invoke_Func = " \n14"
    ...
    If IsError(transit_table) Then
    
        If IsMissing(transit_table) Then
            transit_adr = "MGO TRANSIT"
        ElseIf transit_table Is Nothing Then
            transit_adr = "MGO TRANSIT"
        Else
